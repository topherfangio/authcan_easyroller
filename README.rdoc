...
* I also plan to add the configuration option to turn on e-mail confirmation before users are
  assigned any roles.
* Oh, and I _*definitely*_ plan on updating this for Rails 3.0 when it comes out in a few months!
...
forking thing). However, you do have to have the following gems installed:
